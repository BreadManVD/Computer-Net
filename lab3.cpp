...
int main()
{
    ...
    file << "  4) Virsuniu skaicius: " << nodeNumber << endl;
    getline(data, tmp);

    
    int graph[maxName][maxName]{0};
    data >> startingCity;
    cout << "Pradzia: " << startingCity << endl;
    file << "  5) Pradzios miestas: " << startingCity << endl;
    getline(data, tmp);

    data >> destinationCity;
    cout << "Galas: " << destinationCity << endl;
    file << "  6) Keliones tikslas: " << destinationCity << endl;
    getline(data, tmp);

    data >> traveler;
    file << "  7) Vaziuojantis zmogus: " << traveler << endl;
    getline(data, tmp);
    getline(data, tmp);
    getline(data, tmp);
